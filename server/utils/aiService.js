...
//     // If API key not available, generate a fallback message
//     if (!apiKey) {
...
//     const message = response.data.contents[0].parts[0].text.trim();
//     return message;
//   } catch (error) {
...
// // Fallback message generator when API is not available
...
//   // Return a random message from the template options
